    ...
    <section className="bg-light-150 w-full py-20 px-6 md:px-12 lg:px-24 font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="flex flex-col items-start justify-center">
          ...
          <Link
            to="/contact" 
            className="group flex items-center gap-2 text-(--color-teal-dark) text-lg font-semibold hover:text-accent-dark transition-colors"
          >
            See Openings
            {/* Arrow Icon */}
            <svg 
        ...
        <div className="bg-dark-500 rounded-4xl w-full min-h-87.5 md:min-h-100 flex flex-col justify-center items-center text-center p-8 md:p-12 shadow-2xl">
          ...
          <h3 className="text-white text-2xl md:text-3xl font-medium mb-1">
            Join Neffto<span className="text-primary-soft">.</span>
          </h3>
          
          {/* Big Bold Text */}
          <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
            <span className="text-transparent bg-clip-text bg-primary-soft">GROW</span> <span className="text-white">WITH US</span>
          </h2>
        </div>
