...
const FeatureCard = ({ card }) => {
  ...
  return (
    ...
    >
      ...
      />
      <div
        className={`absolute inset-0 transition-all duration-500 bg-linear-to-t from-black/95 via-black/30 to-transparent ${isHovered ? "backdrop-blur-xs" : "backdrop-blur-0"}`}
      />
