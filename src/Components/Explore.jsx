  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <h1 className="text-[50px] md:text-[80px] lg:text-[96px] leading-[1.1] font-bold mb-6 
                       bg-gradient-to-r from-[#CB8104] to-[#00419B] bg-clip-text text-transparent">
        ...
        <button 
          ...
          className="group relative flex items-center justify-center w-12 h-12 bg-[#111] rounded-full transition-transform hover:scale-110 cursor-pointer shadow-xl animate-bounce"
        >
          <svg 
